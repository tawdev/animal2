            ...
            <div className="bg-slate-50 border-b border-slate-100 py-24">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight uppercase italic">
                        Politique de <span className="text-[#1A5319]">Confidentialité</span>
                    </h1>
                    <p className="text-lg text-slate-500 font-medium max-w-2xl mx-auto italic">
                        La protection de vos données personnelles est une priorité absolue chez PetMarket. Découvrez comment nous gérons vos informations en toute transparence.
                    </p>
                </div>
            </div>
                ...
                <div className="space-y-16">
                    ...
                    <div className="prose prose-slate max-w-none">
                        <p className="text-slate-600 font-medium leading-[1.8] text-[17px]">
                            Cette politique de confidentialité explique comment nous collectons, utilisons, stockons et protégeons vos données à caractère personnel lorsque vous utilisez notre site web <span className="text-[#1A5319] font-bold">petmarket.ma</span> et nos services associés. En utilisant notre site, vous acceptez les pratiques décrites dans cette politique.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_2.5fr] gap-12">
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            <div className="w-14 h-14 bg-[#F0FDF4] rounded-2xl flex items-center justify-center text-[#1A5319] mb-4">
                                <Database size={28} />
                            </div>
                        ...
                        <div className="text-slate-600 font-medium leading-relaxed space-y-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>Historique des commandes et préférences d'achat pour vos animaux.</li>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_2.5fr] gap-12">
                        ...
                        <div className="text-slate-600 font-medium leading-relaxed space-y-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>Envoi d'offres promotionnelles adaptées à vos animaux (uniquement avec votre consentement).</li>
