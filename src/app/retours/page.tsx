        ...
        <div className="flex-1 bg-slate-50">
            ...
            <div className="bg-white border-b border-slate-200 pt-20 pb-16">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <div className="w-16 h-16 bg-[#F0FDF4] rounded-3xl flex items-center justify-center text-[#1A5319] mx-auto mb-6 shadow-sm">
                        <RefreshCcw size={32} />
                    </div>
                    <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight uppercase italic">
                        Retours & <span className="text-[#1A5319]">Échanges</span>
                    </h1>
            ...
            <div className="max-w-4xl mx-auto px-4 py-20">
                {/* 7 Days Policy */}
                <div className="bg-slate-900 rounded-[40px] p-8 md:p-12 text-white mb-16 relative overflow-hidden transition-all hover:shadow-2xl hover:shadow-[#1A5319]/10">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[#1A5319] opacity-10 rounded-full -mr-32 -mt-32 blur-3xl"></div>
                    <div className="flex flex-col md:flex-row items-center gap-10">
                        <div className="shrink-0 w-32 h-32 border-4 border-[#1A5319] rounded-full flex flex-col items-center justify-center relative">
                            <span className="text-4xl font-black text-white">7</span>
                            <span className="text-[10px] font-black uppercase tracking-widest text-[#1A5319]">Jours</span>
                            <div className="absolute -bottom-2 -right-2 bg-[#1A5319] p-1.5 rounded-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-white p-8 rounded-[32px] border border-slate-200 transition-all hover:-translate-y-1 hover:shadow-xl">
                                <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center text-[#1A5319] mb-6 shadow-inner">
                                    {step.icon}
                                </div>
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={i} className="flex gap-4 items-start text-slate-600 font-medium text-[15px]">
                                    <CheckCircle2 size={18} className="text-[#1A5319] shrink-0 mt-0.5" />
                                    {note}
                                </li>
                            ))}
                        </ul>
                ...
                <div className="mt-20 text-center">
                    <div className="inline-flex items-center gap-3 p-5 bg-white rounded-3xl border border-slate-200 shadow-sm">
                        <HelpCircle size={24} className="text-[#1A5319]" />
                        <span className="text-slate-700 font-bold">Encore un doute ?</span>
                        <Link href="/faqs" className="text-[#1A5319] font-black underline underline-offset-4 hover:opacity-80 transition-opacity">
                            Consultez notre FAQ
                        </Link>
                    </div>
                </div>
